...
import (
	...
	"github.com/moaabb/microservices/product-images/handlers"
...
func main() {
	...
	stor, err := files.NewLocal(1024*1000*5, *basePath)
	if err != nil {
	...
	ph.HandleFunc("/images/{id:[0-9]+}/{filename:[a-zA-Z]+\\.[a-z]{3}}", fh.UploadFile)
	...
	go func() {
		...
		l.Info("Server starting on port", *bindAddress)
